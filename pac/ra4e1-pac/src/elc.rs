...
impl Elsr12 {
    ...
    pub fn els(
        self,
    ) -> crate::common::RegisterField<0, 0x1ff, 1, 0, u16, Elsr12_SPEC, crate::common::RW> {
        crate::common::RegisterField::<0,0x1ff,1,0,u16, Elsr12_SPEC,crate::common::RW>::from_register(self,0)
    }
}
...
impl Elcsarc {
    ...
    pub fn elsr(
        self,
    ) -> crate::common::RegisterField<0, 0x3, 1, 0, elcsarc::Elsr, Elcsarc_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<0,0x3,1,0,elcsarc::Elsr, Elcsarc_SPEC,crate::common::RW>::from_register(self,0)
    }
}
