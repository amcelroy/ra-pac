...
impl Cmpsel0 {
    ...
    pub fn cmpsel(
        self,
    ) -> crate::common::RegisterField<0, 0x7, 1, 0, cmpsel0::Cmpsel, Cmpsel0_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<0,0x7,1,0,cmpsel0::Cmpsel, Cmpsel0_SPEC,crate::common::RW>::from_register(self,0)
    }
}
...
impl Cmpsel1 {
    ...
    pub fn crvs(
        self,
    ) -> crate::common::RegisterField<0, 0x3f, 1, 0, cmpsel1::Crvs, Cmpsel1_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<0,0x3f,1,0,cmpsel1::Crvs, Cmpsel1_SPEC,crate::common::RW>::from_register(self,0)
    }
}
...
impl Cmpmon {
    ...
    pub fn reserved(
        self,
    ) -> crate::common::RegisterField<1, 0x7f, 1, 0, u8, Cmpmon_SPEC, crate::common::R> {
        crate::common::RegisterField::<1,0x7f,1,0,u8, Cmpmon_SPEC,crate::common::R>::from_register(self,0)
    }
...
impl Cpioc {
    ...
    pub fn reserved(
        self,
    ) -> crate::common::RegisterField<1, 0x3f, 1, 0, u8, Cpioc_SPEC, crate::common::RW> {
        crate::common::RegisterField::<1,0x3f,1,0,u8, Cpioc_SPEC,crate::common::RW>::from_register(self,0)
    }
