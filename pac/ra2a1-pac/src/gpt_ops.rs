...
impl Opscr {
    ...
    pub fn grp(
        self,
    ) -> crate::common::RegisterField<24, 0x1, 1, 0, opscr::Grp, Opscr_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<24,0x1,1,0,opscr::Grp, Opscr_SPEC,crate::common::RW>::from_register(self,0)
    }
