...
impl Dadr0 {
    ...
    pub fn dadr(
        self,
    ) -> crate::common::RegisterField<0, 0xffff, 1, 0, u16, Dadr0_SPEC, crate::common::RW> {
        crate::common::RegisterField::<0,0xffff,1,0,u16, Dadr0_SPEC,crate::common::RW>::from_register(self,0)
    }
}
...
impl Daadscr {
    ...
    pub fn reserved(
        self,
    ) -> crate::common::RegisterField<0, 0x7f, 1, 0, u8, Daadscr_SPEC, crate::common::RW> {
        crate::common::RegisterField::<0,0x7f,1,0,u8, Daadscr_SPEC,crate::common::RW>::from_register(self,0)
    }
}
...
impl Davrefcr {
    ...
    pub fn reserved(
        self,
    ) -> crate::common::RegisterField<3, 0x1f, 1, 0, u8, Davrefcr_SPEC, crate::common::RW> {
        crate::common::RegisterField::<3,0x1f,1,0,u8, Davrefcr_SPEC,crate::common::RW>::from_register(self,0)
    }
    #[doc = "D/A Reference Voltage Select"]
    #[inline(always)]
    pub fn r#ref(
        self,
    ) -> crate::common::RegisterField<0, 0x7, 1, 0, davrefcr::Ref, Davrefcr_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<0,0x7,1,0,davrefcr::Ref, Davrefcr_SPEC,crate::common::RW>::from_register(self,0)
    }
}
...
impl Dapc {
    ...
    pub fn reserved(
        self,
    ) -> crate::common::RegisterField<1, 0x7f, 1, 0, u8, Dapc_SPEC, crate::common::RW> {
        crate::common::RegisterField::<1,0x7f,1,0,u8, Dapc_SPEC,crate::common::RW>::from_register(self,0)
    }
    #[doc = "Charge Pump Enable"]
    #[inline(always)]
    pub fn pumpen(
        self,
    ) -> crate::common::RegisterField<0, 0x1, 1, 0, dapc::Pumpen, Dapc_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<0,0x1,1,0,dapc::Pumpen, Dapc_SPEC,crate::common::RW>::from_register(self,0)
    }
}
