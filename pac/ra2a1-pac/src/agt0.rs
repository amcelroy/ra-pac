...
impl Agtiosel {
    ...
    pub fn reserved(
        self,
    ) -> crate::common::RegisterField<0, 0xf, 1, 0, u8, Agtiosel_SPEC, crate::common::RW> {
        crate::common::RegisterField::<0,0xf,1,0,u8, Agtiosel_SPEC,crate::common::RW>::from_register(self,0)
    }
}
