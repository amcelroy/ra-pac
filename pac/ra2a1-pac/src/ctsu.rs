...
impl Ctsumch1 {
    ...
    pub fn reserved(
        self,
    ) -> crate::common::RegisterField<6, 0x3, 1, 0, u8, Ctsumch1_SPEC, crate::common::R> {
        crate::common::RegisterField::<6,0x3,1,0,u8, Ctsumch1_SPEC,crate::common::R>::from_register(self,0)
    }
