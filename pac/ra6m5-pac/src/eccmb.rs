...
impl Ec710Ead0 {
    ...
    pub fn ecead(
        self,
    ) -> crate::common::RegisterField<0, 0x7ff, 1, 0, u16, Ec710Ead0_SPEC, crate::common::R> {
        crate::common::RegisterField::<0,0x7ff,1,0,u16, Ec710Ead0_SPEC,crate::common::R>::from_register(self,0)
    }
}
