...
impl Mmpusedmac {
    ...
    pub fn mmpus(
        self,
    ) -> crate::common::RegisterField<5, 0x7ffffff, 1, 0, u32, Mmpusedmac_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<5,0x7ffffff,1,0,u32, Mmpusedmac_SPEC,crate::common::RW>::from_register(self,0)
    }
}
...
impl Mmpueedmac {
    ...
    pub fn mmpue(
        self,
    ) -> crate::common::RegisterField<5, 0x7ffffff, 1, 0, u32, Mmpueedmac_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<5,0x7ffffff,1,0,u32, Mmpueedmac_SPEC,crate::common::RW>::from_register(self,0)
    }
}
