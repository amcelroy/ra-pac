...
impl Sfmcst {
    ...
    pub fn eromr(
        self,
    ) -> crate::common::RegisterField<7, 0x1, 1, 0, sfmcst::Eromr, Sfmcst_SPEC, crate::common::R>
    {
        crate::common::RegisterField::<7,0x1,1,0,sfmcst::Eromr, Sfmcst_SPEC,crate::common::R>::from_register(self,0)
    }
