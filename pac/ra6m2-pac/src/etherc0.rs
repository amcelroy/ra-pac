...
impl Mpr {
    ...
    pub fn mp(
        self,
    ) -> crate::common::RegisterField<0, 0xffff, 1, 0, u16, Mpr_SPEC, crate::common::W> {
        crate::common::RegisterField::<0,0xffff,1,0,u16, Mpr_SPEC,crate::common::W>::from_register(self,0)
    }
}
