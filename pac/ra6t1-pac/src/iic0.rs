...
impl Icwur2 {
    ...
    pub fn reserved(
        self,
    ) -> crate::common::RegisterField<3, 0x1f, 1, 0, u8, Icwur2_SPEC, crate::common::R> {
        crate::common::RegisterField::<3,0x1f,1,0,u8, Icwur2_SPEC,crate::common::R>::from_register(self,0)
    }
