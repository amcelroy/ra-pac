...
impl Crcsar {
    ...
    pub fn crcsa(
        self,
    ) -> crate::common::RegisterField<0, 0x3fff, 1, 0, u16, Crcsar_SPEC, crate::common::RW> {
        crate::common::RegisterField::<0,0x3fff,1,0,u16, Crcsar_SPEC,crate::common::RW>::from_register(self,0)
    }
}
