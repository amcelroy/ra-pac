...
impl Cbwer {
    ...
    pub fn bwe(
        self,
    ) -> crate::common::RegisterField<0, 0x1, 1, 0, cbwer::Bwe, Cbwer_SPEC, crate::common::RW> {
        crate::common::RegisterField::<0,0x1,1,0,cbwer::Bwe, Cbwer_SPEC,crate::common::RW>::from_register(self,0)
    }
}
