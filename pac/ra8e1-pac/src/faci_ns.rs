...
impl Fsaddr {
    ...
    pub fn fsaddr(
        self,
    ) -> crate::common::RegisterField<0, 0xffffffff, 1, 0, u32, Fsaddr_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<0,0xffffffff,1,0,u32, Fsaddr_SPEC,crate::common::RW>::from_register(self,0)
    }
}
