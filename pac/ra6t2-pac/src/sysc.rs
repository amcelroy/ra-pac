...
impl Dpfsar {
    ...
    pub fn dpfsa8(
        self,
    ) -> crate::common::RegisterField<8, 0x1, 1, 0, dpfsar::Dpfsa8, Dpfsar_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<8,0x1,1,0,dpfsar::Dpfsa8, Dpfsar_SPEC,crate::common::RW>::from_register(self,0)
    }
    #[doc = "Deep Software Standby Interrupt Factor Security Attribute bit n (n = 8 to 15)"]
    #[inline(always)]
    pub fn dpfsa9(
        self,
    ) -> crate::common::RegisterField<9, 0x1, 1, 0, dpfsar::Dpfsa9, Dpfsar_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<9,0x1,1,0,dpfsar::Dpfsa9, Dpfsar_SPEC,crate::common::RW>::from_register(self,0)
    }
    #[doc = "Deep Software Standby Interrupt Factor Security Attribute bit n (n = 8 to 15)"]
    #[inline(always)]
    pub fn dpfsa10(
