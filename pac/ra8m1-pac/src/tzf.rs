...
impl Tzfoad {
    ...
    pub fn reserved(
        self,
    ) -> crate::common::RegisterField<1, 0x7f, 1, 0, u8, Tzfoad_SPEC, crate::common::RW> {
        crate::common::RegisterField::<1,0x7f,1,0,u8, Tzfoad_SPEC,crate::common::RW>::from_register(self,0)
    }
    #[doc = "Key Code"]
    #[inline(always)]
    pub fn key(
...
impl Tzfpt {
    ...
    pub fn reserved(
        self,
    ) -> crate::common::RegisterField<1, 0x7f, 1, 0, u8, Tzfpt_SPEC, crate::common::RW> {
        crate::common::RegisterField::<1,0x7f,1,0,u8, Tzfpt_SPEC,crate::common::RW>::from_register(self,0)
    }
    #[doc = "Key Code"]
    #[inline(always)]
    pub fn key(
