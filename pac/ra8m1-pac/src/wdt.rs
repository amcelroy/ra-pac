...
impl Wdtcr {
    ...
    pub fn reserved(
        self,
    ) -> crate::common::RegisterField<14, 0x3, 1, 0, u8, Wdtcr_SPEC, crate::common::RW> {
        crate::common::RegisterField::<14,0x3,1,0,u8, Wdtcr_SPEC,crate::common::RW>::from_register(self,0)
    }
}
...
impl Wdtcstpr {
    ...
    pub fn reserved(
        self,
    ) -> crate::common::RegisterField<0, 0x7f, 1, 0, u8, Wdtcstpr_SPEC, crate::common::RW> {
        crate::common::RegisterField::<0,0x7f,1,0,u8, Wdtcstpr_SPEC,crate::common::RW>::from_register(self,0)
    }
