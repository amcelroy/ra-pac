...
impl Icbrl {
    ...
    pub fn reserved(
        self,
    ) -> crate::common::RegisterField<6, 0x3, 1, 0, u8, Icbrl_SPEC, crate::common::RW> {
        crate::common::RegisterField::<6,0x3,1,0,u8, Icbrl_SPEC,crate::common::RW>::from_register(self,0)
    }
}
