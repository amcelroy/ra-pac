...
impl Agtisr {
    ...
    pub fn reserved(
        self,
    ) -> crate::common::RegisterField<3, 0x1f, 1, 0, u8, Agtisr_SPEC, crate::common::RW> {
        crate::common::RegisterField::<3,0x1f,1,0,u8, Agtisr_SPEC,crate::common::RW>::from_register(self,0)
    }
}
...
impl Agtiosel {
    ...
    pub fn reserved(
        self,
    ) -> crate::common::RegisterField<5, 0x7, 1, 0, u8, Agtiosel_SPEC, crate::common::RW> {
        crate::common::RegisterField::<5,0x7,1,0,u8, Agtiosel_SPEC,crate::common::RW>::from_register(self,0)
    }
}
