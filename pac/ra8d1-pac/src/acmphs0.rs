...
impl Cpintctl {
    ...
    pub fn reserved(
        self,
    ) -> crate::common::RegisterField<1, 0x7f, 1, 0, u8, Cpintctl_SPEC, crate::common::RW> {
        crate::common::RegisterField::<1,0x7f,1,0,u8, Cpintctl_SPEC,crate::common::RW>::from_register(self,0)
    }
}
