...
impl Rsr {
    ...
    pub fn reserved(
        self,
    ) -> crate::common::RegisterField<3, 0x1f, 1, 0, u8, Rsr_SPEC, crate::common::RW> {
        crate::common::RegisterField::<3,0x1f,1,0,u8, Rsr_SPEC,crate::common::RW>::from_register(self,0)
    }
}
