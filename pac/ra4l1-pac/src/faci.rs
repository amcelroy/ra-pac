...
impl Fbcaddr {
    ...
    pub fn bcadr(
        self,
    ) -> crate::common::RegisterField<0, 0xffffff, 1, 0, u32, Fbcaddr_SPEC, crate::common::R> {
        crate::common::RegisterField::<0,0xffffff,1,0,u32, Fbcaddr_SPEC,crate::common::R>::from_register(self,0)
    }
}
