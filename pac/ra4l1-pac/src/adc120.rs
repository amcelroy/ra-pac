...
impl Adctdr {
    ...
    pub fn adctdr(
        self,
    ) -> crate::common::RegisterField<0, 0xffff, 1, 0, u16, Adctdr_SPEC, crate::common::R> {
        crate::common::RegisterField::<0,0xffff,1,0,u16, Adctdr_SPEC,crate::common::R>::from_register(self,0)
    }
}
