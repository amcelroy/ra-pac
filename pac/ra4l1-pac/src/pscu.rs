...
impl Psarb {
    ...
    pub fn psarb0(
        self,
    ) -> crate::common::RegisterField<0, 0x1, 1, 0, psarb::Psarb0, Psarb_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<0,0x1,1,0,psarb::Psarb0, Psarb_SPEC,crate::common::RW>::from_register(self,0)
    }
    ...
    pub fn psarb5(
        self,
    ) -> crate::common::RegisterField<5, 0x1, 1, 0, psarb::Psarb5, Psarb_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<5,0x1,1,0,psarb::Psarb5, Psarb_SPEC,crate::common::RW>::from_register(self,0)
    }
...
impl Psarc {
    ...
    pub fn psarc4(
        self,
    ) -> crate::common::RegisterField<4, 0x1, 1, 0, psarc::Psarc4, Psarc_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<4,0x1,1,0,psarc::Psarc4, Psarc_SPEC,crate::common::RW>::from_register(self,0)
    }
...
impl Psard {
    ...
    pub fn psard29(
        self,
    ) -> crate::common::RegisterField<29, 0x1, 1, 0, psard::Psard29, Psard_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<29,0x1,1,0,psard::Psard29, Psard_SPEC,crate::common::RW>::from_register(self,0)
    }
}
...
impl Mssar {
    ...
    pub fn mssar4(
        self,
    ) -> crate::common::RegisterField<4, 0x1, 1, 0, mssar::Mssar4, Mssar_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<4,0x1,1,0,mssar::Mssar4, Mssar_SPEC,crate::common::RW>::from_register(self,0)
    }
}
