...
impl Elsr {
    ...
    pub fn els(
        self,
    ) -> crate::common::RegisterField<0, 0x3f, 1, 0, u8, Elsr_SPEC, crate::common::RW> {
        crate::common::RegisterField::<0,0x3f,1,0,u8, Elsr_SPEC,crate::common::RW>::from_register(self,0)
    }
}
