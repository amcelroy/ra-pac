...
impl P8Sar {
    ...
    pub fn pmnsa(
        self,
    ) -> crate::common::RegisterField<0, 0xffff, 1, 0, p8sar::Pmnsa, P8Sar_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<0,0xffff,1,0,p8sar::Pmnsa, P8Sar_SPEC,crate::common::RW>::from_register(self,0)
    }
}
