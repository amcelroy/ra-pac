...
impl PrcrS {
    ...
    pub fn prkey(
        self,
    ) -> crate::common::RegisterField<8, 0xff, 1, 0, u8, PrcrS_SPEC, crate::common::W> {
        crate::common::RegisterField::<8,0xff,1,0,u8, PrcrS_SPEC,crate::common::W>::from_register(self,0)
    }
}
