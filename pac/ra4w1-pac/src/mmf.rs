...
impl Mmsfr {
    ...
    pub fn reserved(
        self,
    ) -> crate::common::RegisterField<0, 0x7f, 1, 0, u8, Mmsfr_SPEC, crate::common::RW> {
        crate::common::RegisterField::<0,0x7f,1,0,u8, Mmsfr_SPEC,crate::common::RW>::from_register(self,0)
    }
}
...
impl Mmen {
    ...
    pub fn reserved(
        self,
    ) -> crate::common::RegisterField<1, 0x7fffff, 1, 0, u32, Mmen_SPEC, crate::common::RW> {
        crate::common::RegisterField::<1,0x7fffff,1,0,u32, Mmen_SPEC,crate::common::RW>::from_register(self,0)
    }
