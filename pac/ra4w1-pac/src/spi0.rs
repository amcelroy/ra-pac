...
impl Spscr {
    ...
    pub fn reserved(
        self,
    ) -> crate::common::RegisterField<3, 0x1f, 1, 0, u8, Spscr_SPEC, crate::common::RW> {
        crate::common::RegisterField::<3,0x1f,1,0,u8, Spscr_SPEC,crate::common::RW>::from_register(self,0)
    }
...
impl Spdcr {
    ...
    pub fn reserved(
        self,
    ) -> crate::common::RegisterField<2, 0x3, 1, 0, u8, Spdcr_SPEC, crate::common::RW> {
        crate::common::RegisterField::<2,0x3,1,0,u8, Spdcr_SPEC,crate::common::RW>::from_register(self,0)
    }
