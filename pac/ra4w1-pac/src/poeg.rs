...
impl Poegg {
    ...
    pub fn reserved(
        self,
    ) -> crate::common::RegisterField<17, 0x7ff, 1, 0, u16, Poegg_SPEC, crate::common::RW> {
        crate::common::RegisterField::<17,0x7ff,1,0,u16, Poegg_SPEC,crate::common::RW>::from_register(self,0)
    }
