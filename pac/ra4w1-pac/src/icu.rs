...
impl Wupen {
    ...
    pub fn reserved(
        self,
    ) -> crate::common::RegisterField<21, 0x3, 1, 0, u8, Wupen_SPEC, crate::common::RW> {
        crate::common::RegisterField::<21,0x3,1,0,u8, Wupen_SPEC,crate::common::RW>::from_register(self,0)
    }
