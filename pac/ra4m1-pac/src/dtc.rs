...
impl Dtccr {
    ...
    pub fn reserved(
        self,
    ) -> crate::common::RegisterField<0, 0x7, 1, 0, u8, Dtccr_SPEC, crate::common::RW> {
        crate::common::RegisterField::<0,0x7,1,0,u8, Dtccr_SPEC,crate::common::RW>::from_register(self,0)
    }
}
