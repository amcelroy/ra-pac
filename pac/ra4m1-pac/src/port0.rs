...
impl Pcntr2 {
    ...
    pub fn reserved(
        self,
    ) -> crate::common::RegisterField<16, 0xffff, 1, 0, u16, Pcntr2_SPEC, crate::common::R> {
        crate::common::RegisterField::<16,0xffff,1,0,u16, Pcntr2_SPEC,crate::common::R>::from_register(self,0)
    }
    #[doc = "Pmn Input Data"]
    #[inline(always)]
    pub fn pidr(
