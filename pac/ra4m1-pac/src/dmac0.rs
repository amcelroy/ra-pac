...
impl Dmtmd {
    ...
    pub fn reserved(
        self,
    ) -> crate::common::RegisterField<2, 0x3f, 1, 0, u8, Dmtmd_SPEC, crate::common::RW> {
        crate::common::RegisterField::<2,0x3f,1,0,u8, Dmtmd_SPEC,crate::common::RW>::from_register(self,0)
    }
...
impl Dmreq {
    ...
    pub fn reserved(
        self,
    ) -> crate::common::RegisterField<1, 0x7, 1, 0, u8, Dmreq_SPEC, crate::common::RW> {
        crate::common::RegisterField::<1,0x7,1,0,u8, Dmreq_SPEC,crate::common::RW>::from_register(self,0)
    }
...
impl Dmsts {
    ...
    pub fn reserved(
        self,
    ) -> crate::common::RegisterField<1, 0x7, 1, 0, u8, Dmsts_SPEC, crate::common::RW> {
        crate::common::RegisterField::<1,0x7,1,0,u8, Dmsts_SPEC,crate::common::RW>::from_register(self,0)
    }
